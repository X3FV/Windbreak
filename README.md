...
| --------------------------- | ----------------------- | ----------------------------------------------------------------- |
| **DeepSeek V4.1 Flash**     | Full and limited access | The default everywhere; fast coding and tool use, unmetered       |
| **GLM 5.3 Flash**           | Full and limited access | Cheapest of the included models; deep reasoning, unmetered         |
